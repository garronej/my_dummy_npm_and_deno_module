...
import * as fs from "https://deno.land/std@0.70.0/node/fs.ts";
import * as path from "https://deno.land/std@0.70.0/node/path.ts";
import { TextDecoder } from "https://deno.land/std@0.70.0/node/util.ts";
